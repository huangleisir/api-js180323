...
public class UserLevel implements Serializable {
    ...
    public UserLevel withId(String id) {
        this.setId(id);
        return this;
    }
    ...
    public UserLevel withUserId(String userId) {
    ...
    public UserLevel withUserLevel(Integer userLevel) {
    ...
    public UserLevel withUserAccountMr(Integer userAccountMr) {
    ...
    public UserLevel withIsPopUp(Integer isPopUp) {
        this.setIsPopUp(isPopUp);
        return this;
    }
    ...
    public UserLevel withRemark(String remark) {
    ...
    public UserLevel withEnable(Integer enable) {
    ...
    public UserLevel withCreateTime(Date createTime) {
    ...
    public UserLevel withCreateBy(String createBy) {
    ...
    public UserLevel withLastUpdateTime(Date lastUpdateTime) {
    ...
    public UserLevel withLastUpdateBy(String lastUpdateBy) {

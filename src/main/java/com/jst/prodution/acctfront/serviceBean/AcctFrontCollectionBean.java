...
public class AcctFrontCollectionBean extends BaseBean {
	...
	private String userId; // 会员号(实体)
	private String acctId; // 账户(实体)
	private String acctName; // 账户名称(实体)
	private String acctType; // 账户类型(实体)
	...
	private String oppUserId;// 对方会员号(虚拟)
	private String oppAcctId;// 对方账户(虚拟,如待清算账户、备付金账户等)
	private String oppAcctName;// 对方账户名称(虚拟)
	private String oppAcctType;// 对方账户类型(虚拟)

...
public class CloudOfflineBean extends BaseBean {
    ...
    public String toString() {
        return "CloudOfflineBean [merchantId=" + merchantId + ", userId=" + userId + ", jstMerchantId=" + jstMerchantId
                ...
                + ", tranState=" + tranState + ", notifyId=" + notifyId + ", tranAmountSum=" + tranAmountSum
                + ", needAmountSum=" + needAmountSum + ", disCountAmtSum=" + disCountAmtSum
                + ", cloudOfflineRecordBeanList=" + cloudOfflineRecordBeanList + "]";
    }

...
public class MerchantElectronicInvoiceBean extends BaseBean {
	...
	private String  overTaxDiskAddr;		// 转交邮寄地址
	...
	public String getOverTaxDiskAddr() {
		return overTaxDiskAddr;
	}
	public void setOverTaxDiskAddr(String overTaxDiskAddr) {
		this.overTaxDiskAddr = overTaxDiskAddr;
	}

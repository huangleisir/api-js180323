...
public class TranCoreOfflineIncorrectSupplementQueryListBean extends BaseBean{
    ...
    private Long settAmt;//清算金额
    
    private Long qdiscAmt;//全网券金额
    
    private Long settAmtSum;//清算金额汇总
    
    private Long qdiscAmtSum;//全网券金额汇总
	...
	public Long getSettAmtSum() {
		return settAmtSum;
	}

	public void setSettAmtSum(Long settAmtSum) {
		this.settAmtSum = settAmtSum;
	}

	public Long getQdiscAmtSum() {
		return qdiscAmtSum;
	}

	public void setQdiscAmtSum(Long qdiscAmtSum) {
		this.qdiscAmtSum = qdiscAmtSum;
	}

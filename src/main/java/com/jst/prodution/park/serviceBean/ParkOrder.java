...
public class ParkOrder implements Serializable {
    ...
    private String totpromoteamt; //优惠总金额
    
    private String outype ;
    
    private String isYun = "0" ;
    
    private String kpflag = "0" ;
    
    private String kpUrl = "" ;
    
    public String getTotpromoteamt() {
		return totpromoteamt;
	}

	public void setTotpromoteamt(String totpromoteamt) {
		this.totpromoteamt = totpromoteamt;
	}

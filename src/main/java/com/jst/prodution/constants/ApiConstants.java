...
public final class ApiConstants {
	...
	/*账户类型(01-基本户,02-待结算账户,03-备付金账户,04-待清算账户, 05-代扣长款户,06-代付长款户,07-代扣短款户,08-代付短款户,09-贷款收款户,10-贷款付款户,11-积分账户)*/
	...
	public static final String ACCT_TYPE_JFH = "11";
	...
	public static final class SysResCode{
		...
		public static final String SYS_RES_CODE_ACCT_QUERY_MEMBER_POINTS = "ACCT011";
		public static final String SYS_RES_CODE_ACCT_DED_DED = "ACCT012";
		//账户end
		...
		public static final String SYS_RES_CODE_SETT_QUERY_SEVICE_ERROR = "SETT0010";
		...
		public static final String SYS_RES_CODE_LANE_YFK_QUERY  = "LANE0102";
		// 通道前置end
...
//		public static final String SYS_RES_CODE_TRAN_CASH_WITH_APPROVE = "TRAN003";
	...
	/**接口版本号前缀*/
	public static final String INTERFACE_VERSION	 	= "INTERFACE_VERSION"; 		//接口版本号前缀
	
	/**通道处理结果不确定*/
	public static final String LANE_RESULT_NOT_SURE       = "LANE0648";         //通道处理结果不确定
	/**通道前置处理结果不确定*/
	public static final String LANEFRONT_RESULT_NOT_SURE  = "LANEFRONT10500";    //通道前置处理结果不确定
	/**支付核心处理结果不确定*/
	public static final String PAYCORE_RESULT_NOT_SURE  = "PAYCORE10500";       //支付核心处理结果不确定
